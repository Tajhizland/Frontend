...
export interface SectionHero2Props {
    className?: string;
    data: LandingBannerResponse[]
}

let TIME_OUT: NodeJS.Timeout | null = null;

const SectionHeroLanding: FC<SectionHero2Props> = ({className = "", data}) => {
    // =================
            ...
            >
                <div className=" w-full h-full">
                    <Image
                        ...
                        alt={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}/landing-banner/${item.image}`}
                        priority
                    />
...
export default SectionHeroLanding;
