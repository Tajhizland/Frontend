...
const TabCategoryFilters = ({filters, categorys, changeFilter, minPrice, maxPrice}: {
    ...
    const renderFilters = () => {
        return (
            ...
            filters && filters.map((filter, index) => (<Fragment key={index}>
                <div
                    className={`flex items-center justify-center px-4 py-2 text-sm rounded-full border focus:outline-hidden cursor-pointer select-none
                        border-neutral-300 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 hover:border-neutral-400 dark:hover:border-neutral-500
                        `}
            ...
            <>
                {categorys && categorys.length > 0 &&
                    <div
                        ...
                        onClick={openModalMoreFilter}
                    >
                        <span className="line-clamp-1  mr-2">دسته بندی</span>
    ...
    const renderTabsPriceRage = () => {
        return (
            <div
                ...
                onClick={openModalMoreFilter}
            >
                <span className="line-clamp-1  mr-2">محدوده قیمت</span>
                {isOnSale && renderXClear()}
            </div>
        );
    };
                      ...
                      <ButtonClose onClick={closeModalMoreFilter}/>
                                    ...
                                    <div className="grow overflow-y-auto">
                                        <div
                                            ...
                                            {categorys && categorys.length > 0 && <div className="py-7">
    ...
    return (
        <div className="  lg:space-x-4 overflow-x-auto sm:overflow-visible flex sm:hidden pb-5">
            {/* FOR DESKTOP */}
            <div className="flex flex-1 gap-x-4  whitespace-nowrap">
                {renderTabsPriceRage()}
                {renderFilters()}
                {renderCategorys()}
                {renderTabIsOnsale()}
...
export default TabCategoryFilters;
