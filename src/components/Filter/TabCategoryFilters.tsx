...
const TabFilters = ({filters,categorys, changeFilter, minPrice, maxPrice}: {
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <ButtonThird
                                                onClick={() => {
                                                    close();
                                                    handleRemoveFilter(filter.id as string)
                                                    setColorsState([]);
                                                }}
                                                sizeClass="px-4 py-2 sm:px-5"
                                            >
    ...
    return (
        <div className="  lg:space-x-4 overflow-x-auto sm:overflow-visible hidden sm:flex">
            {/* FOR DESKTOP */}
