...
const widgetMenus: WidgetFooterMenu[] = [
    {
        ...
        menus: [
            ...
            {href: "/page/ghavanin", label: "قوانین سایت"},
            {href: "/page/raviyeersal", label: "رویه ارسال سفارشات"},
            {href: "/page/khadamatpasazfrosh", label: "خدمات پس از فروش"},
        ],
    },
    {
        id: "1",
        ...
        title: "تجهیزلند بلاگ",
        menus: [
            {href: "/page/tajhizrahandazi", label: "تجهیز و راه اندازی"},
            {href: "/page/mosshvereamozesh", label: "مشاوره و آموزش"},
            {href: "/page/zemanatesalat", label: "ضمانت اصالت کالا"},
            {href: "/page/ersal", label: "ارسال به سراسر کشور"},
            {href: "/page/hamkarifrosh", label: " همکاری با تولید و تامین کنندگان"},
