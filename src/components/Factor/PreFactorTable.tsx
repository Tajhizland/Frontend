                ...
                <table className="w-full text-xs text-left rtl:text-right text-gray-500">
                    ...
                    {cart.map((item) => (
                        <tr key={item.id} className="border-b">
                            ...
                            <td className="px-4 py-2 text-center">
                                <Prices price={   (item.guaranty.free==null || item.guaranty.free) ? 0 : GuarantyPrice(item.color.price)}
                ...
                {cart.map((item) => (
                    <div key={item.id} className="bg-white px-4 pb-4 rounded-lg shadow-md border">
                        ...
                        <div className="mt-2 grid grid-cols-2 gap-2 text-sm">
                            ...
                            <span><Prices price={   (item.guaranty.free==null || item.guaranty.free)  ? 0 : GuarantyPrice(item.color.price)}/></span>
