    ...
    return (
        <>
            ...
            >
                ...
                <div className="space-y-1  px-2.5 pt-1 sm:pt-2">

                    <div>
                        <h2 className="nc-ProductCard__title text-xs md:text-sm  font-semibold transition-colors text-right dark:text-white  min-h-[2lh] h-[2lh] leading-[0.7lh] line-clamp-2">
                            {data?.name}
                        </h2>
                    </div>
