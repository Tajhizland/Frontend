...
import {VlogCategoryListingResponse} from "@/services/types/vlog";
...
export default function VlogCategoryListing({response, search, url}: { response: VlogCategoryListingResponse, search?: string, url: string }) {
