    ...
    },
    {
        ...
        content:
            <ul className="list-disc list-inside leading-7">
                <li>All full-priced, unworn items, with tags attached and in their original packaging are eligible for
                    return or exchange within 30 days of placing your order.
                </li>
                <li>
...
const AccordionInfo: FC<Props> = ({
    ...
    return (
        <div className="w-full rounded-2xl space-y-2.5">
            ...
            {data.map((item, index) => {
                return (
                    <Disclosure key={index} defaultOpen={index < 3}>
                        {({open}) => (
                            <>
                                <Disclosure.Button
