        ...
        <div className="glide__track" data-glide-el="track" style={{direction:"ltr"}}>
            <ul className="glide__slides">
                ...
                <li className={`glide__slide   `}>
                    <Link href={"/brand-list"} className="block relative group">
                        <div className="relative rounded-2xl overflow-hidden h-[410px]">
                            ...
                            <div className="absolute inset-y-6 inset-x-10  flex flex-col items-center justify-center">
                                <div className="flex items-center justify-center relative">
                                    <span
                                        className="text-xs  lg:text-xl font-semibold whitespace-nowrap">نمایش همه  </span>
                                    <svg
                                ...
                                <span
                                    className="text-xs  lg:text-sm mt-1 whitespace-nowrap">نمایش همه‌ی برند ها        </span>
                            </div>
                        </div>
                    </Link>
                </li>
