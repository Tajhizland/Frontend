...
(useWallet: boolean, shippingMethod: number,shippingPrice: number , code?:string) => {
    return axios.post<T, SuccessResponseType<T>>("payment/request", {wallet: useWallet, shippingMethod: shippingMethod, code: code , shippingPrice: shippingPrice})
