...
export const columns = defineColumns<ProductResponse>([
    ...
    {key: 'width', header: 'عرض بسته', editable: true},
    {key: 'height', header: 'ارتفاع بسته', editable: true},
    {key: 'length', header: 'طول بسته', editable: true},
    {key: 'weight', header: 'وزن محصول', editable: true},
    {
        key: 'status',
        header: 'وضعیت',
        editable: true,
